  ...
  return (
    <div className="-translate-y-10 flex h-screen fixed mt-10 ">
      <aside className="text-white w-64 flex-shrink-0">
        <ul className="py-4">
          <li className="text-lg  bg-gradient-to-r from-[#a18cd1] to-[#fbc2eb] rounded-full -translate-x-6">
            <Link
          ...
          <li className="text-lg -translate-x-6 hover:bg-gradient-to-r from-[#a18cd1] to-[#fbc2eb] rounded-full">
